...
.inst-header {
    background: linear-gradient(135deg, #0a1628 0%, #0d1f45 50%, #1a0a0a 100%);
    border-bottom: 3px solid #c9242c;
    padding: 22px 32px;
...
.materia-card {
    ...
    border: 1px solid #c9242c44; border-left: 4px solid #c9242c;
...
.metric-box {
    background: linear-gradient(145deg, #0d1b3e, #152444);
    border: 1px solid #c9a84c33; border-top: 3px solid #c9242c;
...
.stButton > button {
    background: linear-gradient(135deg, #c9242c, #e05060) !important;
    color: #ffffff !important; font-weight: 700 !important;
    border: none !important; border-radius: 6px !important;
}
.stButton > button:hover {
    opacity: .9 !important;
    box-shadow: 0 4px 12px rgba(201,36,44,.35) !important;
}

.gold-divider {
    height: 1px;
    background: linear-gradient(90deg, transparent, #c9242c, transparent);
    margin: 20px 0;
}
.versiculo {
    background: #0a1528; border-left: 3px solid #c9242c;
...
def exportar_excel():
    ...
    gold_fill  = PatternFill("solid", fgColor="C9242C")
...
with st.sidebar:
    st.markdown(f'''<div style="text-align:center;padding:16px 0 8px">
      <img src="data:image/jpeg;base64," style="width:72px;height:72px;border-radius:50%;border:2px solid #c9242c"/>
